...
const formattedDate = `${year}-${month}-${day}`;
  ...
  const table = $('#tbl_reporteInasistencias').DataTable({
    ajax: {
      url: ruta + 'controllers/asistenciaController.php?option=listarInasxfechaActual',
      dataSrc: ''
    },
    columns: [
      { data: 'id' },
  ...
  $('#btn-filtrar').on('click', function () {
    ...
    if (fechaInicial && fechaFinal) {
      ...
      axios.post(ruta + 'controllers/asistenciaController.php?option=listarInasxRangoFechas', formData)
